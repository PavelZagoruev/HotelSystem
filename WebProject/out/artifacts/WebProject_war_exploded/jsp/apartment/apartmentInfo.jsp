    ...
    <div id="table1" class="panel panel-default">
        ...
        <table class="table" >
            ...
            <tr>
                ...
                <td><div id="dataEntry" style="display:none"><t:translate key="placeholder.apartment.orderEntry"/></div></td>
                <td><div id="dataExit" style="display: none"><t:translate key="placeholder.apartment.orderExit"/></div> </td>
                <td></td>
            </tr>
            ...
            <c:forEach items="${apartments}" var="apartment">
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" id="${apartment.id-1}"  style="display:none" name="${apartment.id}-1"/> </td>
                    <td><input type="text" class="form-control" id="${apartment.id+1}"  style="display:none" name="${apartment.id}+1"/> </td>
                    <td><input type="submit" id="${apartment.id+100}" class="newclass"  style="display:none" value="<t:translate key="apartment.registration"/>"/></td>
                </form>
