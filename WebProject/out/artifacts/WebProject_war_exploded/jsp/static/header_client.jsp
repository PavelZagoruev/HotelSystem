                ...
                <ul class="nav navbar-nav">
                    <li>
                        <form action="${pageContext.servletContext.contextPath}/controller" method="post">
                            <input type="hidden" name="command" value="show_hotels">
                            <input type="submit" class="btn btn-default" value=" <t:translate key="link.main.client"/>"/>
                        </form>
                    </li>
                    <li>
                        <form action="${pageContext.servletContext.contextPath}/controller" method="post">
                            <input type="hidden" name="command" value="show_client_orders">
